...
// The `GptoolsID` scalar type represents an identifier for an object of type Gptools.
type GptoolsID string
...
func (r *Gptools) WithGraphQLQuery(q *querybuilder.Selection) *Gptools {
	return &Gptools{
		query: q,
	}
}
...
func (r *Gptools) Audio(url string) *File {
	q := r.query.Select("audio")
	q = q.Arg("url", url)
...
func (r *Gptools) BaseCtr() *Container {
	q := r.query.Select("baseCtr")
...
// A unique identifier for this Gptools.
func (r *Gptools) ID(ctx context.Context) (GptoolsID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response GptoolsID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Gptools) XXX_GraphQLType() string {
	return "Gptools"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Gptools) XXX_GraphQLIDType() string {
	return "GptoolsID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Gptools) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Gptools) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *Gptools) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadGptoolsFromID(GptoolsID(id))
	return nil
}

// Runs a RAG model on the provided source directory and question
func (r *Gptools) Rag(ctx context.Context, openaiApiKey *Secret, source *Directory, question string) (string, error) {
	assertNotNil("openaiApiKey", openaiApiKey)
	assertNotNil("source", source)
	if r.rag != nil {
		return *r.rag, nil
	}
	q := r.query.Select("rag")
	q = q.Arg("openaiApiKey", openaiApiKey)
	q = q.Arg("source", source)
	q = q.Arg("question", question)
...
func (r *Gptools) Transcript(src *File) *File {
...
func (r *Gptools) YtChat(ctx context.Context, openaiApiKey *Secret, url string, question string) (string, error) {
	assertNotNil("openaiApiKey", openaiApiKey)
	if r.ytChat != nil {
		return *r.ytChat, nil
	}
	q := r.query.Select("ytChat")
	q = q.Arg("openaiApiKey", openaiApiKey)
	q = q.Arg("url", url)
	q = q.Arg("question", question)
...
func (r *Gptools) Ytctr() *Container {
	q := r.query.Select("ytctr")
...
func (r *Gptools) Yturl(ctx context.Context) (string, error) {
	if r.yturl != nil {
		return *r.yturl, nil
	}
	q := r.query.Select("yturl")
...
func (r *Client) Gptools() *Gptools {
	q := r.query.Select("gptools")
...
// Load a Gptools from its ID.
func (r *Client) LoadGptoolsFromID(id GptoolsID) *Gptools {
	q := r.query.Select("loadGptoolsFromID")
	q = q.Arg("id", id)
